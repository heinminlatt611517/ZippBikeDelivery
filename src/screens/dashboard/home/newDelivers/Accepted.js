...
const Accepted = ({navigation, route}) => {
  ...
  //press events
  const handleOnPressDispatch = () => {
    console.log('ID', id);
    dispatch(orderActions.postOrderStatus(id, 'Dispatched', navigation));
  };
  return (
    <ImageBackground
      source={IMGS.bgImg}
      ...
      <View style={styles.container}>
        <View style={{flexDirection: 'row', marginTop: MARGINS.m20}}>
